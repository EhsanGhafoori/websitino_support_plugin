...
function websitino_theme_styles_Sidebar()  
{   
...
// add_action('admin_head', 'websitino_theme_styles_Sidebar');
add_action( 'admin_enqueue_scripts', 'websitino_theme_styles_Sidebar', 10 );
// MENU
