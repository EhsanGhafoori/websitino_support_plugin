...
?>
	...
	<div class="container px-4 py-5" id="featured-3">
		...
		<div class="d-flex flex-row align-items-center pt-3 border-top grid gap-0 column-gap-3">
		...
		<p>
			- <?php _e('Added Arabic language along with fixing some small bugs', 'websitinu') ?>
		</p>
		<?php
